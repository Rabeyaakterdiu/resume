...
<?php
 ...
 $results = mysqli_query($db, "SELECT * FROM detail");
    $count = 0;
    ...
    <div class="wrapper">
        <div class="sidebar-wrapper">
            <div class="profile-container">
                ...
                <h3 class="tagline"><?php echo $row["position"]; ?></h3>
            </div><!--//profile-container-->
            
            <div class="contact-container container-block">
                <ul class="list-unstyled contact-list">
                    <li class="email"><i class="fas fa-envelope"></i><a href="#"><?php echo $row["email"]; ?></a></li>
                    <li class="phone"><i class="fas fa-phone"></i><a href="#"><?php echo $row["phone"]; ?></a></li>
                    <li class="website"><i class="fas fa-globe"></i><a href="#" target="_blank"><?php echo $row["website"]; ?></a></li>
                </ul>
            ...
            <span>
            <button style="margin-left: 20px;" type="button" class="btn btn-warning"><a href="edit.php?id=<?php echo $row["id"]; ?>">Edit</a></button>
            </span>

            <span>
            <button style="margin-left: 20px;" type="button" class="btn btn-danger"><a href="delete.php?id=<?php echo $row["id"]; ?>">Delete</a></button>
            </span>
        </div><!--//sidebar-wrapper-->
